...
ADAPTOR_NAME = os.environ.get("ADAPTOR_NAME", "../saved_model/MATH/qwen_sft_3_512_5e-5")
...
OUT_DIR      = os.environ.get("OUTPUT_DIR", "../saved_model/MATH/qwen_mixed_1_512_1e-5")
MERGED_DIR   = os.environ.get("MERGED_DIR", "../saved_model/MATH/qwen_mixed_merged_1_512_1e-5")
