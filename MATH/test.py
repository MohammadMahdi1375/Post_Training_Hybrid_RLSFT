...
MODEL_PATH     = os.environ.get("MODEL_PATH", "/home/mohammad-m/TTT/saved_model/MATH/sft_lora_FT_1/")
...
def main():
    ...
    # progress_bar = tqdm(range(0, len(rows)-4990, BATCH_SIZE), desc="Processing")
    progress_bar = tqdm(range(0, len(rows)-4990, BATCH_SIZE), desc="Processing")
